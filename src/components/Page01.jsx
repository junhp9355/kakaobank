        ...
        <div className="area01">
          ...
          <section className="Page01Icons">
            <div className="iconBanner">
              <a href="#!" className="googleIconName">Google Play
                <div className="icon">
                  <img className="googleIcon" src="img/kakaobank icon.png" alt="googleIcon"></img>
                </div>
              </a>
            </div>

            <div className="iconBanner2">
              <a href="#!" className="appleIconName">App Store
                <div className="icon2">
                  <img className="appleIcon" src="img/kakaobank icon.png" alt="appleIcon"></img>
                </div>
              </a>
            </div>
          </section>
